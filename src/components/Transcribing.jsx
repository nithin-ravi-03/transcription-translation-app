...
const Transcribing = (props) => {
  ...
  return (
    <div className='flex items-center flex-1 flex-col justify-center gap-10 text-center md:gap-14 py-2 p-4'>
        <div className='flex flex-col gap-2 sm:gap-4'>
            ...
            <p>{!downloading ?'warming up cylinders ..please wait..':'core cylinders engaged' }</p>
        </div>
